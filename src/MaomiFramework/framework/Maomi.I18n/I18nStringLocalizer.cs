...
namespace Maomi.I18n
{
    public class I18nStringLocalizer : IStringLocalizer
    {
        ...
        // 如果查找不到 key，不要返回 null，可以返回 new LocalizedString(name, name, true)
        public LocalizedString this[string name] => _kvs.GetValueOrDefault(name) ?? new LocalizedString(name, name, true);
